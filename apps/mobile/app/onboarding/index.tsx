...
const PERSONALITY_ITEMS: { id: string; prompt: string }[] = [
  ...
  {
    id: "bfi-3",
    prompt: "I see myself as someone who is dependable and self-disciplined.",
  },
];
...
export default function OnboardingScreen() {
  ...
  const handleSubmit = async () => {
    if (!accessToken) {
      ...
      Alert.alert(
        "Not signed in",
        "Please sign in before completing onboarding.",
      );
      return;
    }
    ...
    try {
      ...
      setProfile({
        ...
        legalAcceptedAt:
          history.profile?.legal_acceptance_at ?? new Date().toISOString(),
        onboardingCompletedAt:
          history.profile?.onboarding_completed_at ?? new Date().toISOString(),
      });
      try {
    ...
    case 1:
      return (
        <View style={styles.card}>
          ...
          <Text style={styles.body}>
            Optional basics that help us understand your context.
          </Text>
          <TextInput
            style={styles.input}
          ...
          <View style={styles.chipRow}>
            {genderOptions.map((option) => (
              <TouchableOpacity
                ...
                style={[
                  styles.chip,
                  data.demographics.gender === option && styles.chipSelected,
                ]}
                onPress={() => {
                  hapticSelection();
                  onUpdateData((previous) => ({
                    ...
                    demographics: {
                      ...previous.demographics,
                      gender:
                        previous.demographics.gender === option
                          ? undefined
                          : option,
                    },
                  }));
              ...
              >
                <Text
                  style={[
                    styles.chipLabel,
                    data.demographics.gender === option &&
    ...
    case 2:
      return (
        <View style={styles.card}>
          ...
          <Text style={styles.body}>
            Rate each domain from 1 (low) to 5 (high).
          </Text>
    ...
    case 3:
      return (
        <View style={styles.card}>
          ...
          <Text style={styles.body}>
            Respond on a scale from 1 (strongly disagree) to 5 (strongly agree).
          </Text>
              ...
              <View style={styles.ratingButtons}>
                {[1, 2, 3, 4, 5].map((score) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.ratingButton,
                      data.personality[item.id] === score &&
                        styles.ratingButtonSelected,
                    ]}
                    onPress={() => {
                      hapticSelection();
    ...
    case 4:
      return (
        <View style={styles.card}>
          ...
          <Text style={styles.body}>
            Pick up to three values that feel most energising. We’ll use them to
            anchor quests and coaching.
          </Text>
          <View style={styles.chipGrid}>
            {VALUE_OPTIONS.map((option) => {
              const isSelected = data.values.finalRound.includes(option.value);
              const limitReached =
                !isSelected && data.values.finalRound.length >= 3;
              return (
                <TouchableOpacity
                  key={option.value}
                  style={[
          ...
          <Text style={styles.helperText}>
            Selected: {data.values.finalRound.join(", ") || "None yet"}
          </Text>
        </View>
      );
    case 5:
      return (
        <View style={styles.card}>
          ...
          <Text style={styles.body}>
            These prompts feed directly into your Personal Insights report.
          </Text>
    ...
    case 6:
      return (
        <View style={styles.card}>
          ...
          <Text style={styles.body}>
            Name yourself so Fermi can address you properly, then confirm the
            legal note.
          </Text>
          <TextInput
            style={styles.input}
          ...
          <View style={styles.legalRow}>
            ...
            <Text style={styles.legalText}>
              I understand Purpose is a coaching experience, not medical or
