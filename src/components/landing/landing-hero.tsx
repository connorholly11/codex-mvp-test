...
export function LandingHero() {
  ...
  return (
    <>
      <section className="flex flex-col gap-6 rounded-3xl bg-surface p-8 shadow-lg shadow-black/10 md:p-12">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <a
            href="/docs"
            className="inline-flex items-center justify-center rounded-full border border-border px-6 py-3 text-sm font-semibold text-foreground transition hover:bg-surface-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
          >
            View technical plan
          </a>
        </div>
