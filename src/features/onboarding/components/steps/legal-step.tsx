  ...
  return (
    <div className="flex flex-col gap-8">
      <header className="flex flex-col gap-2">
        ...
        <h2 className="text-2xl font-semibold text-foreground sm:text-3xl">Coaching, not therapy</h2>
      ...
      <div className="flex flex-col gap-4 rounded-2xl border border-border bg-surface-muted p-5 text-sm sm:p-6">
